...
class SLKSPMessenger:
    ...
    def set_thrust_limit_1(self,a):
        """Engage stability assist system."""
        self.vessel.parts.root.engines[2].thrust_limit = a

    def set_thrust_limit_2(self,b):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[3].thrust_limit = b

    def set_thrust_limit_3(self,c):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[4].thrust_limit = c

    def set_thrust_limit_4(self,d):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[5].thrust_limit = d
        
    def set_thrust_limit_5(self,e):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[6].thrust_limit = e

    def set_thrust_limit_6(self,f):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[7].thrust_limit = f

    def set_thrust_limit_7(self,g):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[8].thrust_limit = g

    def set_thrust_limit_8(self,h):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[9].thrust_limit = h

    def set_thrust_limit_9(self,i):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[10].thrust_limit = i

    def set_thrust_limit_10(self,j):
        """Engage stability assist system."""
        self.vessel.parts.children.engines[11].thrust_limit = j
